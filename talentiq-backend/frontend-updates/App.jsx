// src/App.jsx
// ──────────────────────────────────────────────────────────────
// REPLACES the original App.jsx
//
// Changes from your original:
//   • Removed in-browser data processing (processTAData etc.)
//   • Loads from the backend on mount
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F3F4F6", fontFamily: "'Outfit','DM Sans',sans-serif", color: C.slate800 }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
          ...
          <div style={{ display: "flex", gap: 2 }}>
            {[{ k: "dashboard", l: "Dashboard" }, { k: "mapping", l: "Skill Mapping" }].map((n) => (
      ...
      {page === "dashboard"
        ? <DashboardPage data={dashData || emptyDash} />
        : <SkillMappingPage positions={positions} bench={bench} />}
